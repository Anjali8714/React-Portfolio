    ...
    <section id='about' className="p-16">
      <div>
        ...
        <div className='flex gap-10 p-8 mt-6 justify-between'>
            <img src="Images/photo.jpg" alt="Personal photo" width="20%" height="20%"  />
          <div className='text-white text-xl flex flex-col justify-center gap-8 pl-3 pr-3 w-[1100px] h-[400px] rounded-[30px] bg-[#212121] shadow-[15px_15px_30px_rgb(25,25,25),-15px_-15px_30px_rgb(60,60,60)]'>
